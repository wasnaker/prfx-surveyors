...
class Surveyor_merge_fields extends App_merge_fields
{
    public function build()
    {
        return [
                ...
                [
                    'name'      => 'Surveyor Files Admin Link',
                    'key'       => '{surveyor_profile_files_admin_link}',
                    'available' => [

                    ],
                    'templates' => [
                        'new-surveyor-profile-file-uploaded-to-staff',
                    ],
                ],
                [
                    'name'      => 'Client Website',
    ...
    /**
     * Merge fields for Contacts and Surveyors
    ...
    public function format($client_id, $contact_id = '', $password = '')
    {
        ...
        $fields['{surveyor_profile_files_admin_link}'] = '';
        ...
        $fields['{surveyor_profile_files_admin_link}'] = admin_url('clients/client/' . $client->userid . '?group=attachments');
        ...
        $custom_fields = get_custom_fields('surveyors');
        foreach ($custom_fields as $field) {
            $fields['{' . $field['slug'] . '}'] = get_custom_field_value($client_id, $field['id'], 'surveyors');
        }
